...
<!-- NOTES 2 MA
# add "boundary=b" to gf_histogram (maybe in 2.8-2.11)
# add |> gf_density() to gf_histogram
# add an example for gf_boxplot after filter 
# add boxplot under histogram (where?)
-->
